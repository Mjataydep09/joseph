    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                ...
                <li class="nav-item"><a class="nav-link link text-white display-4" href="index.php#team1-f">Our Team<br></a></li>
            ...
            echo "<div class='row timeline-element ".$runservice['service_position']." separline'>
                ...
                <div class='col-xs-12 col-md-6 align-left'>
                    <div class='timeline-text-content boxbordershadow'>
                        <h4 class='align-center mbr-timeline-title pb-3 mbr-fonts-style display-5' >
...
<div class="container-fluid">
        <div class="row" style="position:relative;overflow:hidden;" >
            <div class="col-md-12 aboutcontainer"  id="slider1-b">
                <h2 class="align-center mbr-fonts-style display-2 marginbottomstyle">ABOUT US</h2>
